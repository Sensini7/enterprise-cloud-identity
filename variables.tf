...
variable "terms_of_use_id" {
  description = "The ID of the uploaded TOU page. Must be uploaded manually and supplied as an input. The ID may be obtained by using `Get-MgIdentityGovernanceTermsOfUseAgreement`"
  type        = string
}
...
variable "maintenance_mode" {
  description = "Maintenance mode variable dictating whether changes can be made to Azure Policy"
  type        = bool
  default     = false
}